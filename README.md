...
sudo apt-get install python3 python3-pip
```
3. Install a virtual environment encapsulating the Log4jShell_Scanner repository.
```shell
python3 -m venv Log4jShell_Scanner 
```
...
6. Create a custom jndi payload or obtain a test payload. Huntress generates test payloads at the following link: [Huntress Payload Generator](https://log4shell.huntress.com/)  
...
7. Update the domains.txt file with your end points. Examples are above and in the text file included in this repository.

8. Run the script and add additional flags as necessary. An example is included below to help you implement each flag.
```shell
...
All of the flags for this shell script are briefly described within the help menu. If you need a reminder of any of the flags while using this program the type the following:
